...
/// <summary>Central dark theme for in-game ImGui windows — ported from GameHelper with POE2Radar accents.</summary>
internal static class ImGuiTheme
{
    internal static readonly Vector4 Accent = new(0.30f, 0.85f, 0.95f, 1f);
    internal static readonly Vector4 AccentMuted = new(0.22f, 0.62f, 0.72f, 1f);
    ...
    internal const float TooltipWrapFactor = 35f;
    ...
    internal static float ControlWidth(float fontSizeFactor = 12f)
        => ImGui.GetFontSize() * fontSizeFactor;
}
