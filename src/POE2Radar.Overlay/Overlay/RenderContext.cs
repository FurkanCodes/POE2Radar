...
public readonly record struct StashTierLineView(
    string Tier,
    uint TierColor,
    string Modifier,
    string Roll);

public readonly record struct StashTierMetricView(
    string Label,
    string Value,
    string Tier,
    uint TierColor);

public readonly record struct HoveredStashTierView(
    NumVec2 Pos,
    NumVec2 Size,
    string ItemType,
    string OverallTier,
    uint OverallColor,
    string TierNote,
    StashTierMetricView[] Metrics,
    StashTierLineView[] Modifiers);
...
public sealed record RenderContext(
    ...
    HoveredStashTierView? HoveredStashTier,
    ...
    IReadOnlyDictionary<(int X, int Y), NumVec2>? AtlasRitualNodeCenters = null,
    ...
    int AtlasRitualLineLength = 0,
    int AtlasRitualCommittedMaps = 0,
    int AtlasRitualPlannerTotalChains = 0,
    bool AtlasRitualPlannerCapped = false,
