    ...
    public static void ApplyIconDefaults(List<DisplayRule> rules)
    {
        foreach (var r in rules)
        {
            switch (r.Name)
            {
                ...
                case "Strongbox · Unique": r.Sprite ??= SpriteCatalog.ChestUnique().Clone(); r.Size = Math.Max(r.Size, 12f); break;
                case "Strongbox · Landmark": r.Sprite ??= SpriteCatalog.Landmark().Clone(); r.Size = Math.Max(r.Size, 12f); break;
                case "Strongbox · Cartographer": r.Sprite ??= SpriteCatalog.MapMarker().Clone(); r.Size = Math.Max(r.Size, 12f); break;
                case "Strongbox · Researcher": r.Sprite ??= SpriteCatalog.ChestRare().Clone(); r.Size = Math.Max(r.Size, 11f); break;
                case "Strongbox · Abyss": r.Sprite ??= SpriteCatalog.Strongbox().Clone(); r.Size = Math.Max(r.Size, 11f); break;
                ...
                case "Ultimatum": r.Sprite ??= SpriteCatalog.Ritual().Clone(); r.Size = Math.Max(r.Size, 12f); break;
                case "Corruption": r.Sprite ??= SpriteCatalog.Delirium().Clone(); r.Size = Math.Max(r.Size, 12f); break;
                case "Strongbox · Arcane": r.Sprite ??= SpriteCatalog.ChestRare().Clone(); r.Size = Math.Max(r.Size, 11f); break;
                case "Strongbox · Armourer": r.Sprite ??= SpriteCatalog.Strongbox().Clone(); r.Size = Math.Max(r.Size, 11f); break;
                case "Strongbox · Jeweller": r.Sprite ??= SpriteCatalog.ChestRare().Clone(); r.Size = Math.Max(r.Size, 11f); break;
                case "Strongbox · Divination": r.Sprite ??= SpriteCatalog.MapMarker().Clone(); r.Size = Math.Max(r.Size, 11f); break;
                case "Strongbox · Expedition": r.Sprite ??= SpriteCatalog.Expedition().Clone(); r.Size = Math.Max(r.Size, 11f); break;
