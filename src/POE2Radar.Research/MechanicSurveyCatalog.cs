...
internal static class MechanicSurveyCatalog
{
    ...
    private static readonly Def[] Defs = new[]
    {
        ...
        new Def("Ultimatum", ["LeagueUltimatum", "/Ultimatum/", "UltimatumAltar"], ["Object", "Other"], ["ultimatumboss"]),
        new Def("Corruption",
            ["precursorcorruption", "VaalCorruption", "CorruptionAltar", "TrailOfCorruption"],
            ["Object", "Other"], null),
        new Def("Strongbox · Unique",
            ["uniquevaalstrongbox", "uniqueezomytegrave", "uniqueetchedbeetle", "ventorstrongbox", "beaststrongbox",
                "uniqueventorsmysterybox"],
            ["Chest"], null),
        new Def("Strongbox · Landmark", ["landmarkstrongbox"], ["Chest"], null),
        new Def("Strongbox · Cartographer", ["cartographer"], ["Chest"], null),
        new Def("Strongbox · Arcane", ["arcanist"], ["Chest"], null),
        new Def("Strongbox · Armourer", ["armory"], ["Chest"], null),
        new Def("Strongbox · Jeweller", ["gemcutter", "gemstrongbox"], ["Chest"], null),
        new Def("Strongbox · Divination", ["strongboxdivination", "strongboxdivinationshaper"], ["Chest"], null),
        new Def("Strongbox · Expedition", ["strongboxexpedition"], ["Chest"], null),
        new Def("Strongbox · Researcher", ["strongboxes/strongbox"], ["Chest"],
            ["landmarkstrongbox", "cartographer", "unique", "beaststrongbox", "ventorstrongbox", "abyssstrongbox",
                "arcanist", "armory", "gemcutter", "gemstrongbox", "strongboxdivination", "strongboxexpedition"]),
        new Def("Strongbox · Abyss", ["abyssstrongbox"], ["Chest"], null),
